            ...
            <section className="py-16 bg-white">
                <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-10 px-6">
                    ...
                    <div className="text-center shadow-md p-8 rounded-xl hover:shadow-xl transition">
                        ...
                        <p className="text-gray-600">+92 336 9900430</p>
                    ...
                    <div className="text-center shadow-md p-8 rounded-xl hover:shadow-xl transition">
                        ...
                        <p className="text-gray-600">l240583@lhr.nu.edu.pk</p>
                        <p className="text-gray-600">l240765@lhr.nu.edu.pk</p>
                        <p className="text-gray-600">l240684@lhr.nu.edu.pk</p>
                    </div>
                    ...
                    <div className="text-center shadow-md p-8 rounded-xl hover:shadow-xl transition">
                        ...
                        <p className="text-gray-600">FAST NUCES, Lahore</p>
                    ...
                    <div>
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center">
                                ...
                                <span className="text-gray-700">+92 336 9900430</span>
                            </div>
                            <div className="flex items-center">
                                <Mail className="text-red-600 mr-3" />
                                <span className="text-gray-700">l240583@lhr.nu.edu.pk</span>
                            </div>
                            <div className="flex items-center">
                                <MapPin className="text-red-600 mr-3" />
                                <span className="text-gray-700">FAST NUCES, Lahore</span>
                            </div>
                        </div>

                        {/* Social Icons */}
                        <div className="flex gap-6 mt-8">
                            <FaInstagram className="w-8 h-8 text-red-600 hover:text-red-700 cursor-pointer" />
                            <FaFacebook className="w-8 h-8 text-red-600 hover:text-red-700 cursor-pointer" />
                            <FaLinkedin className="w-8 h-8 text-red-600 hover:text-red-700 cursor-pointer" />
