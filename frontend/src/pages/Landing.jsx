...
const Landing = () => {
    ...
    const bloodTypes = [
        { type: "O+", need: "Critical", donors: "2,450" },
        { type: "O-", need: "High", donors: "1,890" },
        { type: "A+", need: "High", donors: "2,100" },
        { type: "A-", need: "Normal", donors: "980" },
    ];
    ...
    const processSteps = [
        ...
        },
        {
            ...
            icon: Heart,
            title: "Save Lives",
            description: "Your donation directly impacts patients in critical situations",
        },
    ];
    ...
    const donationFacts = [
        {
            ...
            description:
                "A single blood donation can help save up to 3 lives through component separation.",
            stat: "3 Lives",
        },
        {
            icon: Clock,
            title: "30 Seconds",
            description:
                "Someone needs blood every 30 seconds in hospitals worldwide.",
            stat: "Every 30s",
        },
        {
            icon: Target,
            title: "Year-Round Need",
            description:
                "Blood is needed 365 days a year. No artificial substitute exists yet.",
            stat: "365 Days",
        },
        {
            icon: Droplets,
            ...
            description:
                "Each donation costs about $500 to process, screen, and distribute safely.",
            stat: "$500",
        },
    ];
                ...
                <div className="container mx-auto px-4">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
                        {bloodTypes.map((blood, index) => (
                            ...
                            >
                                <div
                                    className={`text-2xl font-bold mb-2 ${blood.need === "Critical"
                                        ? "text-red-600"
                                        : blood.need === "High"
                                            ? "text-orange-500"
                                            : "text-green-500"
                                ...
                                <div
                                    className={`text-sm font-medium px-2 py-1 rounded-full ${blood.need === "Critical"
